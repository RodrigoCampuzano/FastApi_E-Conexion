...
@router.post("/", response_model=UsuarioHasChatResponse, dependencies=[Depends(verify_token)])
...
@router.get("/by_usuario/{usuario_id}", response_model=List[UsuarioHasChatResponse], dependencies=[Depends(verify_token)])
...
@router.get("/by_chat/{chat_id}", response_model=List[UsuarioHasChatResponse], dependencies=[Depends(verify_token)])
...
@router.delete("/{usuario_id}/{chat_id}", response_model=UsuarioHasChatResponse, dependencies=[Depends(verify_token)])
...
@router.put("/{usuario_id}", response_model=UsuarioHasChatResponse, dependencies=[Depends(verify_token)])
...
@router.get("/", response_model=List[UsuarioHasChatResponse], dependencies=[Depends(verify_token)])
